...
__all__ = ['ACT_MAX_VAL', 'ACT_MIN_VAL']
...
class Quartznet(nn.Module):
    ...
    def restore_checkpoints(self, encoder_state_dict, decoder_state_dict):
        self.encoder.load_state_dict(torch.load(encoder_state_dict, map_location='cpu'))
        self.decoder.load_state_dict(torch.load(decoder_state_dict, map_location='cpu'))
...
def quartznet(cfg, quartzet_params):
    ...
    # ACT_MAX_VAL = absolute_act_val
    # ACT_MIN_VAL = -absolute_act_val
