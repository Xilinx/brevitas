...
class SolveWeightScalingStatsInputDimsFromModule(ExtendedInjector):
    ...
    @value
    def scaling_stats_input_concat_dim():
        if this.scaling_per_output_type == ScalingPerOutputType.TENSOR:
            return 0
        elif this.scaling_per_output_type == ScalingPerOutputType.CHANNEL:
            return 1
