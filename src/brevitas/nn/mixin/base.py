...
class _CachedIO:
    ...
    @property
    def scale(self):
        return getattr(self.quant_tensor, 'scale', None)

    @property
    def zero_point(self):
        return getattr(self.quant_tensor, 'zero_point', None)

    @property
    def bit_width(self):
        return getattr(self.quant_tensor, 'bit_width', None)

    @property
    def signed(self):
        return getattr(self.quant_tensor, 'signed', None)
