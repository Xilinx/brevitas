...
def get_midmax_mantissa_bit_bias(
    ...
    if excess_reserved_values == 0:
        ...
        return torch.log2(torch.tensor(excess_reserved_values + 1)).item()  # The number of bits of the mantissa that are consumed by the reserved values
