...
def q4_k_quant_block(
    ...
    # d_tmp = np.expand_dims(output_d * q_scales, -1) # This should be equivalent to scales
    # dm_tmp = np.expand_dims(output_dmin * q_mins, -1) # This should be equivalent to mins

    # all_L = np.round(
    #     blocks / d_tmp + dm_tmp).astype(
    #         np.uint8)
