...
from brevitas.quant.scaled_int import Int8WeightPerTensorFloat, Int8WeightPerTensorFloatMSE, Int8ActPerTensorFloat
...
qlinear = qnn.QuantLinear(5, 10, weight_quant=Int8WeightPerTensorFloatMSE,
                        weight_float_to_int_impl=SparseRoundSte,
