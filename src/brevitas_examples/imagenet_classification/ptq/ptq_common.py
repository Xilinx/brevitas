...
def quantize_model(
    ...
    weight_bit_width_lambda = weight_bit_width if backend != 'layerwise' else lambda module: bit_width_fn(
        module, weight_bit_width)
    act_bit_width_lambda = act_bit_width if backend != 'layerwise' else lambda module: bit_width_fn(
