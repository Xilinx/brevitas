...
| `rotation_parameter_dtype` | Storage dtype for trainable rotation masters; the model and rotation forward remain in the model dtype. |
| `bit_width_parameter_dtype` | Storage dtype for learned bit-width offsets and their SGD momentum state. |
