...
* Python >= 3.10
* [Pytorch](https://pytorch.org) >= 1.13, <= 2.13 (more recent versions would be untested).
...
- *2026/09/23* - Release version 0.13.4, see the [release notes](https://github.com/Xilinx/brevitas/releases/tag/v0.13.4).
- *2026/09/18* - Release version 0.13.3, see the [release notes](https://github.com/Xilinx/brevitas/releases/tag/v0.13.3).
